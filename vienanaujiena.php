...
<h1 class="antraste container w3-animate-right">Naujienos turinys</h1>
...
<div class="apacia1 row container ">
  <div class=" row ">
    <div class="w3-animate-left col s8  m6  card blue-grey darken-2">
    ...
    <div class="w3-animate-right col s8 m6 card blue-grey darken-4">
      <div class="card-content white-text">
