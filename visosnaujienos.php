...
<div id="naujienu fonas" >
    <div class="konteineris">
        ...
        <div class="tema1">
            ...
            <div ><a href="visosnaujienos.php" id="allnewsbut1"class="waves-effect waves-light large btn">open</a></div>
        ...
        <div class="tema1">
            <img class="nuotraukos" src="https://picsum.photos/301" alt="">
            ...
            <div><a href="visosnaujienos.php" id="allnewsbut2" class="waves-effect waves-light btn">open</a></div>
        </div>
        ...
        <div class="tema1">
            <img class="nuotraukos" src="https://picsum.photos/302" alt="">
            ...
            <div ><a href="visosnaujienos.php" id="allnewsbut3"class="waves-effect waves-light btn">open</a></div>
        </div>
